...
DEST="http://stardock.cs.virginia.edu/oh/queue_count.php"
SP="https://netbadge.virginia.edu/index.cgi"
IDP="https://shibidp.its.virginia.edu/idp/shibboleth"
#IDP="https://shibidp.its.virginia.edu/idp/profile/SAML2/Redirect/SSO"
#IDP="https://netbadge.virginia.edu/"
...
curl -L -s  --data "username=$USERNAME&password=$PASSWORD&lt=$CAS_ID&_eventId=submit&submit=LOGIN" -i -b $COOKIE_JAR -c $COOKIE_JAR $CURL_DEST -D $HEADER_DUMP_DEST -o file.html
